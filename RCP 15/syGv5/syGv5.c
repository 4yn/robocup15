...
int main(void)
{
    ...
    int hmY = 85;			//y home coordinate
    
    //compound eye constants
    char eyeCH = 10;	//begin chase
    int eyeSA = 65;		//begin track
    int eyeSB = 70;		//end chase when in front
    ...
    while (1)
    {
        ...
        else
        {
            ...
            if ( eyePP<d2 )
            {
                ...
                traS=cap(absl(ulX-ulZ+d1)/2+absl(ulY-hmY)+10,100); //align to base power
                if(traS<30){
