    ...
    while (1)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if ( eyeDR<=180) traD=eyeDR+cap((d1*eyePP)/eyeSC,95);
                else if ( eyeDR>180 ) traD=eyeDR-cap((d1*eyePP)/eyeSC,95);
                else traD=eyeDR;
        ...
        //horizontal border control w lr
        if ( LR==0 ) {
