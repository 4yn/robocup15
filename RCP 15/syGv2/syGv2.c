...
int main(void)
{
    ...
    int hmY = 90;			//y home coordinate
    
    //compound eye constants
    char eyeCH = 10;	//begin chase
    int eyeSA = 80;		//begin strafe
    int eyeSB = 130;		//end chase
    int eyeSK = 300;		//start striking
    
    //movement constants
    int traBCx = 55;		//border control horizontal treshold
    int traBCy = 200;		//border contorl vertical treshold
    ...
    int run = 100;		//program run conditional
    int lcd = 100;			//lcd light on/off
    ...
    while (1)
    {
        ...
        if ( eyeFP+eyeBP<eyeCH )
        {
            ...
            traS=cap(absl(ulX-ulZ+hmX)/2+absl(ulY-hmY)+10,50); //align to base power
            if(traS<15){
        ...
        else
        {
            ...
            if ( eyePP< d2 && (eyeDR<70||eyeDR>290) )
            {
                //goalie strafe
                if(eyeDR<180){
                	d1 = -eyeDR;
                ...
                traS=cap(absl(ulX-ulZ+d1)/2+absl(ulY-hmY)+10,50); //align to base power
                //lcd = 10;
            }
            else
            {
                ...
                else
                {
                    ...
                    if ( eyeDR<=180) traD=eyeDR+(d1*eyePP)/145;
                    else if ( eyeDR>180 ) traD=eyeDR-(d1*eyePP)/145;
                    else traD=eyeDR;
                    lcd = 10;
                }
            }
